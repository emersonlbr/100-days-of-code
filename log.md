...
**Thoughts**: It feels great to get the correct answers on FCC, watching the lecture motivated me about learning JS and becoming a developer.
**Link to Work** []()


### Day 6: January 11, 2018

**Today's Progress**: It was a very tiring day, didn't have much time, though I've attempted to solve a FCC challenge, and also read more about javascript objects. Watched a documentary about Aaron Swartz, 5 years ago today he had killed himself, victim of an injustice system.
**Thoughts**: Really motivated to actually learn to code and do whatever I can to help making the world a better place.
**Link to Work** [The Internet's Own Boy: The Story of Aaron Swartz | full movie (2014)](https://www.youtube.com/watch?v=9vz06QO3UkQ)


### Day 7: January 12, 2018

**Today's Progress**: Read some chapters of Eloquent Javascript
**Thoughts**: Due to work I haven't have much free time for now but whenever I can I try to learn a litte bit more about Javasript.
**Link to Work** [#none]()
...
**Today's Progress**: worked on the back-end of Warbler, built the UserSchema, connected it to mongo DB
<!-- **Thoughts**: -->
<!-- **Link to Work**: -->
...
**Today's Progress**: Still worked on the back end part of warbler, setting up some routes and creating new users
<!-- **Thoughts**: -->
<!-- **Link to Work**: -->
...
**Today's Progress**: finished the back end part of warbler.
**Thoughts**: there are quite a few new concepts introduced in this back end section, at some point things have gotten really messy and I kind of had a hard time tying to understand what was doing what.
<!-- **Link to Work**: -->
